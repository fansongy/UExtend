/*
 * This class is Singleton class in all game.
 * 
 * Usage :
 *     1.GameModel gm = Singleton.getInstance("Test")as GameModel;
 *     2.GameModel gm = Singleton.getInstance(ClassName.GAME_MODEL) as GameModel;
 * 
 * by fansy
 */
